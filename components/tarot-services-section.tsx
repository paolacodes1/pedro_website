...
const services: Service[] = [
  {
    id: 'oracular',
    title: 'Oráculo de Etherias',
    description: 'Connect with the ethereal realm through sacred oracle cards. Each reading opens a gateway to higher dimensions, revealing mystical insights about your spiritual journey and life purpose from the cosmic consciousness.',
    price: 'From $60',
    icon: Sparkles,
    cardImage: '🔮',
    benefits: ['Ethereal guidance', 'Spiritual awakening', 'Cosmic insights', 'Soul purpose']
  },
  {
    id: 'thoth',
    title: 'Tarot de Thoth',
    description: 'Dive deep into the esoteric wisdom of Aleister Crowley\'s Thoth deck. Each card unveils profound archetypal truths and ancient mysteries, illuminating your soul\'s path through the sacred geometry of existence.',
    price: 'From $80',
    icon: Eye,
    cardImage: '👁️',
    benefits: ['Ancient wisdom', 'Archetypal insights', 'Esoteric knowledge', 'Soul transformation']
  }
];
...
function TarotCard({ service }: TarotCardProps) {
  ...
  return (
    <div ref={cardRef} className="relative w-full max-w-xs mx-auto perspective-1000">
      ...
      >
        ...
        <div className="absolute inset-0 w-full h-full rounded-2xl bg-gradient-to-br from-rich-burgundy via-deep-maroon to-rich-burgundy shadow-2xl overflow-hidden" 
             style={{ backfaceVisibility: 'hidden', transform: 'rotateY(0deg)' }}>
          <div className="relative h-full p-4">
            {/* White border */}
            <div className="absolute inset-3 bg-ivory-light rounded-lg">
              <div className="absolute inset-1 bg-gradient-to-br from-rich-burgundy via-deep-maroon to-rich-burgundy rounded-md overflow-hidden">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="relative w-32 h-32">
                    ...
                    {/* Rose center */}
                    <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-12 h-12 bg-gradient-to-br from-rich-burgundy via-rich-burgundy/80 to-rich-burgundy rounded-full shadow-lg border-2 border-warm-gold">
                      <div className="absolute inset-1 bg-gradient-to-br from-rich-burgundy/90 to-rich-burgundy rounded-full">
                        <div className="absolute inset-1 bg-gradient-to-br from-rich-burgundy/80 to-rich-burgundy rounded-full">
        ...
        <div className="absolute inset-0 w-full h-full rounded-2xl bg-gradient-to-br from-deep-maroon via-deep-maroon to-rich-burgundy/10 shadow-2xl" 
             style={{ backfaceVisibility: 'hidden', transform: 'rotateY(180deg)' }}>
          <div className="flex flex-col h-full p-6">
            {/* Service Icon - Centered */}
            <div className="flex-1 flex flex-col items-center justify-center text-center space-y-6">
              <div className="w-24 h-24 mx-auto bg-gradient-to-br from-warm-gold to-warm-gold/80 rounded-full flex items-center justify-center shadow-lg">
              ...
              <div className="space-y-2">
                {service.benefits.map((benefit, idx) => (
                  <div key={idx} className="flex items-center justify-center gap-2 text-sm text-ivory-light/70">
...
function ServiceDescription({ service }: ServiceDescriptionProps) {
  ...
  return (
    ...
    >
      ...
      <p className="text-lg leading-relaxed text-ivory-light/80 max-w-2xl">
        {service.description}
      </p>
      
      <div className="flex items-center gap-4">
        <div className="text-2xl font-semibold text-warm-gold">{service.price}</div>
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.95 }}
        className="bg-rich-burgundy hover:bg-rich-burgundy/90 text-ivory-light px-8 py-3 rounded-full font-medium transition-all duration-300 shadow-lg hover:shadow-xl"
      >
        Book {service.title}
      </motion.button>
    </motion.div>
...
export function TarotServicesSection() {
  ...
  return (
    <section ref={containerRef} className="min-h-screen bg-gradient-to-b from-black-pearl to-deep-maroon/20 py-20">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-xl text-ivory-light/70 max-w-3xl mx-auto">
            Unlock ancient mysteries through ethereal divination and sacred wisdom
          </p>
        </motion.div>
